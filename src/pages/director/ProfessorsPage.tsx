...
export function ProfessorsPage() {
  ...
  return (
    <div className="space-y-3 sm:space-y-4 min-h-0" data-tour="professors-page">
      {/* Header */}
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-xl mb-4 sm:mb-6" data-tour="professors-header">
        <div className="flex items-center justify-between p-3 sm:p-4">
          ...
          <button
            ...
            data-tour="create-professor-button"
      ...
      {/* Stats Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-4 sm:mb-6" data-tour="professors-stats">
      ...
      {/* Main Content */}
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm" data-tour="professors-content">
